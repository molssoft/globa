...
if Request.Form("id")="new" then
 ...
 conn.execute ("insert into grupa_pas (datums_izveidots,datums_labots,veids,kurators,rajons,laiks,vieta,klients,adrese,telefons,epasts,piezimes) values ("+datums_izveidots+","+datums_labots+","+veids+","+kurators+","+rajons+","+laiks+","+vieta+","+klients+","+adrese+","+telefons+","+epasts+","+piezimes+")")
 %><body onload="window.close();"><body><%
 Response.End
end if

docstart "Izveidot ierakstu","y1.jpg" %>
<form name=forma method=POST>
<center><font color="GREEN" size="5"><b>Izveidot ierakstu</b></font>
<table border=0>
  ...
  <tr>
   ...
   <td>
    <select name=veids>
     <option value=P>Pasûtîjuma</option>
     <option value=S>Skolçnu</option>
    </select>
   </td>
  </tr>
   ...
   <td>
    <select name=kurators>
     ...
     <% while not rKurators.eof %>
      <option value=<%=rKurators("id")%> ><%=rKurators("v")%></option>
      <% rKurators.movenext%>
     <% wend %>
    </select>
   </td>
   ...
   <td>
    <select name=rajons>
     ...
     <% while not rRajons.eof %>
      <option value=<%=rRajons("id")%>><%=rRajons("nosaukums")%></option>
      <% rRajons.movenext%>
     <% wend %>
    </select>
   </td>
  ...
  <tr>
   ...
   <td>
    <textarea cols=30 rows=3 name="laiks"></textarea>
   </td>
  </tr>
  ...
  <tr>
   ...
   <td>
    <textarea cols=30 rows=3 name="vieta"></textarea>
   </td>
  </tr>
  ...
  <tr>
   ...
   <td>
    <input type=text name="klients" value="" size=40>
   </td>
  </tr>
  ...
  <tr>
   ...
   <td>
    <input type=text name="adrese" value="" size=40>
   </td>
  </tr>
  ...
  <tr>
   ...
   <td>
    <input type=text name="telefons" value="" size=20>
   </td>
  </tr>
  ...
  <tr>
   ...
   <td>
    <input type=text name="epasts" value="" size=40>
   </td>
  </tr>
  ...
  <tr>
   ...
   <td>
    <textarea cols=30 rows=3 name="piezimes"></textarea>
   </td>
  </tr>
</table>
