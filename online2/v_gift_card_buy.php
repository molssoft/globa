...
<html lang="lv">
	...
	<div style="width:100%; text-align:center">
			...
			<div style="height:50px"></div>
				...
				<?}*/?>
				<br>
			<form class="form-signin col-md-4 col-md-offset-4" method="post" action="?f=BuyGiftCard">
				...
				<div class="col-sm-12">
					...
					<input name="summa" id="summa" type="number" step="0.01" min="<?=$data['min_summa'];?>" max="<?=$data['max_summa'];?>" class="form-control" placeholder="" value=""
				...
				<div class="col-sm-12 text-center">
					<a href="#" id="previewGiftCard">Priekðskatît dâvanu karti</a>
				</div>
