...
<html lang="lv">
	...
	<body>
		...
		<div class="container">
			...
			<form class="form-signin col-md-12 " method="post" id="forma" action="?f=HotelsTest">
						...
						*/
						...
						//if ($istaba['veids'] == 'DOUBLE'){
							...
							foreach ($kopa_ar_pieaugusie as  $kopa_ar){
								...
								$berna_vieta = 2;
								/*if ($kopa_ar['kopa_ar_berns'] == 1 && $aiznemtas_vietas_bernu<=$brivas_vietas_bernu){
									echo "bçrna";
							...
							/*if (count($kopa_ar_berni) > $istaba['vietas_bernu']){
								$show_as_adult = 1;
							}
							else $show_as_adult = 0;*/
							$aiznemtas_vietas_bernu = count($kopa_ar_berni);
							//echo "bçrnu vietas: ".$istaba['vietas_bernu']."<br>";
							
							foreach ($kopa_ar_berni as  $kopa_ar){
								if ($aiznemtas_vietas_bernu > $istaba['vietas_bernu']){
									$show_as_adult = 1;
						...
						//numuriòi ar visâm atseviðíâm gultâm
							...
							foreach ($kopa_ar_pieaugusie as  $kopa_ar){
								...
								<td class="td_bed">
									<?if ($kopa_ar['kopa_ar_savejo']){?><div style="position:relative">
										<a class="dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" onclick="showDalibn(<?=$istaba['vietas_id'];?>,<?=$kopa_ar['kopa_ar_did'];?>,'<?=$gultas_nr;?>_1','<?=$dzimumam;?>',<?=$berna_vieta;?>,event);">
									<?}?>		
											<table class="center">
							...
							//izdrukâ aizòemtâs bçrnu vietas
							...
							if ($istaba['vietas_bernu'] >0){
								$brivas_vietas_bernu = $istaba['vietas_bernu'] - $aiznemtas_vietas_bernu;
							}
							else{
								$brivas_vietas_bernu = 0;
							}
							if ($brivas_vietas_bernu <0) $brivas_vietas_bernu = 0;
						
							$brivas_pieauguso_vietas = $brivas_vietas - $brivas_vietas_bernu;
							IF ($_SESSION['profili_id'] == 5116){
								/*echo $istaba['vietas_bernu'];
								 echo 'aiznemtas bernu vietas:'.$aiznemtas_vietas_bernu."<br>";
								echo "BRÎVÂS VIETAS:" .$brivas_vietas."<br>";
								echo "BRÎVÂS Bçrnu VIETAS:" .$brivas_vietas_bernu."<br>";
							...
							for ($i=0;$i<$brivas_pieauguso_vietas;$i++){
								...
								$img_person = $data['bed_images']['free'];
								$align = "center";
								for ($i=0;$i<$brivas_vietas_bernu;$i++){
...
function cancelRoom(vid,did){
	$.ajax({
		...
		success: function(html){ 
			//console.log(html);				
			//alert('izòemts');
			window.location.href = "?f=HotelsTest";
