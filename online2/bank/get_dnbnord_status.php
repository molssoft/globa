...
$db = new Db;
// logs failâ
	file_put_contents("log\get".date("Y-m").".txt",date("Y-m-d H:i:s")." POST DNB STATUS".print_r($_POST,true)."\r\n\r\n",FILE_APPEND);
//exit();
...
$_POST = array('VK_SND_ACC' => 'LV85RIKO0001050477923', 'VK_T_NO' => '681250013', 'VK_T_DATE' => '15.06.2017', 'VK_SND_ID' => 'RIKOLV2X', 'VK_MSG' => 'Impro online rezervacija. Islandes lielais ... (rez_id_24421)', 'VK_VERSION' => '101', 'VK_STAMP' => '849', 'VK_REC_SWIFT' => 'RIKOLV2X', 'VK_T_STATUS' => '2', 'VK_REF' => '7398_906B37F0-7764-', 'VK_REC_ACC' => 'LV76RIKO0002010047384', 'VK_CURR' => 'EUR', 'VK_AMOUNT' => '500.00', 'VK_REC_REG_ID' => '40003235627', 'VK_SERVICE' => '1102', 'VK_MAC' => '', 'VK_SND_NAME' => 'LIEPIÅ…Å  GUNTARS', 'VK_REC_NAME' => 'IMPRO CELOJUMI', 'VK_LANG' => 'LAT', 'VK_REC_ID' => '10022');
*/
//connect_to_mssql();
LogPost($_POST);
