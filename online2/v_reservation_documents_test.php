			...
			<form class="form-signin col-md-12 " method="post" id="forma" action="?f=Documents">
				...
				?>
					<div class="row col-md-12 " <? if ($i%2 == 0){ ?>
						...
						<label for="dokuments_<?=$i;?>" class="col-md-12 text-center"></label>
						...
						<div class="span 12 text-center"></div>
						<!--div class="col-sm-3" >
						<div class="col-sm-12">
							<label for="dok_veids_<?=$i;?>"><span <?if ($i>0){?>class="visible-xs"<?}?>>Dok.veids</label>
							<?// echo $data['checked_dok_veids_'.$i];?>
								
							<select name="dok_veids_<?=$i;?>" id="dok_veids_<?=$i;?>" class="form-control" onChange="changeDocument('<?=$i;?>');" style="font-weight: bolder;">
								<option value="pase" <? 
						...
						<div class="col-sm-7">
							...
							<div class="col-sm-6">
								<label><span id="dok_nr_label" <?if ($i>0){?>class="visible-xs"<?}?>></span><u>Pases</u> numurs</label>
								...
								<label><span id="dok_nr_label" <?if ($i>0){?>class="visible-xs"<?}?>></span><u>Personas apliecîbas</u> numurs</label>
							...
							<div class="col-sm-6">
									...
									<label><span id="dok_der_dat_label" <?if ($i>0){?>class="visible-xs"<?}?>></span><u>Pases</u> derîguma termiòð</label>
									...
									<label><span id="dok_der_dat_label" <?if ($i>0){?>class="visible-xs"<?}?>></span><u>Personas apliecîbas</u> derîguma termiòð</label>
