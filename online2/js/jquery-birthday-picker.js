$(function ($)
{
    var month = {
        ...
        "short": ["Jan", "Feb", "Mar", "Apr", "Mai", "Jûn", "Jûl", "Aug", "Sep", "Okt", "Nov", "Dec"],
        "long": ["Janvâris", "Februâris", "Marts", "Aprîlis", "Maijs", "Jûnijs", "Jûlijs", "Augusts", "Septembris", "Oktobris", "Novembris", "Decembris"]
    },
    today = new Date(),
        ...
        // Create the html picker skeleton
         ...
         // Add the option placeholders if specified
          if (options.placeholder) {
            $("<option value='0'>Gads</option>").appendTo($year);
            $("<option value='0'>Mçnesis</option>").appendTo($month);
            $("<option value='0'>Diena</option>").appendTo($day);
          }
