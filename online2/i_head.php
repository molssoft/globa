  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    if (basename($_SERVER['SCRIPT_FILENAME']) == 'c_login.php' && isset($_GET['f']) && $_GET['f'] == 'forgot') {
    	...
    	echo '<meta name="description" content="IMPRO Ceļojumu veikals - aplūkot. Dažāda veida ceļojumu iespējas, gan ar autobusu, gan ar avio. Piedāvājumā dažādas kombinācijas.">';
