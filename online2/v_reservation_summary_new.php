										...
										?>
											...
											foreach($data['termini'] as $termins){
												...
												if ($i==1){
													...
													$papildus_txt = 'pilna summa ';
												}
												else{
														$papildus_txt = 'vçl ';
												}?>
												<li><?=$when;?> <b><?=$termins['datums'];?></b> jâiemaksâ <?=$papildus_txt?><b><?=$termins['summa'];?> <?=$data['grupas_valuta'];?></b></li>
											<?
												$i++;
											}?>
											...
											<li>
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														...
														<input name=summa_<?=$dalibn["ID"];?> id="summa_<?=$dalibn["ID"];?>" type="text" class="form-control summa" step="0.01" min="0" style="width:8em;float:left;text-align:right" value="" required><span  style="">
										...
										<div class="col-sm-12">
											<div class="checkbox">
													<label for=accepted style="font-weight:700">
														<input type="checkbox" name="accepted" id="accepted"  class="" <? if ($data['apstiprinats']) echo "checked";?>><a id="view_contract" href="?f=GenerateContract" target="_blank" onclick=' $("#view_contract").attr("href", "?f=GenerateContract&avanss=" + $("#karteja_iemaksa_sum").html());'>Apskatît</a> un akceptçt <a id="view_contract" href="?f=GenerateContract" target="_blank" onclick=' $("#view_contract").attr("href", "?f=GenerateContract&avanss=" + $("#karteja_iemaksa_sum").html());'>
											lîgumu</a></label><br><a href="https://www.impro.lv/pdf/<?=$data['pdf_apraksts'];?>.pdf" target="_blank">Lîguma pielikums - Marðruta apraksts</a><br>
											</div>
										</div>
										<br>
										<br>
