...
conn.execute("update sp_marsruts set id = "+cstr(new_id)+", tema1 = '"+ temap +"', tema = '"+ tema +"', marsruts='" + marsruts + "', valoda='" + valoda + "', npk='" + npk + "' where id = "+cstr(id))
response.redirect "sp.asp#"+new_id
%>
