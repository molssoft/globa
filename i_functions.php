...
function DocStart($title,$wallpaper,$include_bootstrap = false) {
	...
	echo "content= 'text/html; charset=windows-1257'>";
	...
	if ($include_bootstrap) echo '<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">';
	echo "</head>";
	 
	echo "<body background=".chr(34).$wallpaper.chr(34)." text=".chr(34)."#000000".chr(34)."";
...
//-------------------------------
//addUser-pievieno jaunu lietotâju, saòemot vârdu un aprakstu
//ja apraksta nav, tad tas kïûst par " "
//-------------------------------
